...
<body>
    <div class="container">
		<textarea id="contentAdd" class="contentAdd" placeholder="在此处输入以添加到便签中" autofocus></textarea>
    ...
    <script src="modules/js/view.min.js"></script>
  	<div class="footer">
  		<div class="navbar" id="navbar">
  			<a onclick='toggleView(this)' id='a_view' class='active'>编辑便签</a>
  			<a onclick='location.reload();' id='a_view' class='active'>重新加载</a>
  		</div>
  	</div>
